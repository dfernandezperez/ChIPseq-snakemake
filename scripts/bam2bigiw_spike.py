...
#############################
bamCompare = "bamCompare -b1 " + snakemake.input["case"] + " -b2 " + snakemake.input["reference"] + " -o " + snakemake.output["bw"] + " -bs 50 --ratio subtract --scaleFactors " + case_norm + ":" + dm_norm + " " + snakemake.threads + " --extendReads 200"
