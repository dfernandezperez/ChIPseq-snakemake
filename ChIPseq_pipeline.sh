...
nohup snakemake -j 999 --cluster-config cluster.json --latency-wait 120 --use-singularity --singularity-args "-B /hpcnfs -H /hpcnfs/home/ieo4462/emptyFolder_singularity" \
